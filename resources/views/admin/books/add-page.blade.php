<x-app-layout>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="grid grid-cols-12 content-center gap-7">
                                ...
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6 2xl:col-span-6">
                                    ...
                                    <x-input id="cover_image" class="form-control
    block
    w-full
    px-3
    py-1.5
    ...
    ease-in-out
    m-0
    focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="file" name="cover_image" autofocus />
                                </div>

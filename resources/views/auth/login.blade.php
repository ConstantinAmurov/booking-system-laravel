...
<div class="container">
    ...
    <form class="text-xl mt-20" action="">
        ...
        <div class="mt-20 flex justify-between">
            ...
            <a href="{{url("/register/")}}"> You don't have an account?</a>
        </div>
        
        <button type="submit" class="w-100 h-12 my-10 rounded-lg bg-blue-500 text-center text-white hover:bg-blue-600">Sign in</button>
    </form>
